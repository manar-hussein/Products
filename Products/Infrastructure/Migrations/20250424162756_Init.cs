        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberOfExisitItems = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductsBuyers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductsBuyers_Buyers_BuyerId",
                        column: x => x.BuyerId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductsBuyers_ProductId",
                table: "ProductsBuyers",
                column: "ProductId");
        }
